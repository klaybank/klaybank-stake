...
interface IKlaybankIncentivesController is IKlaybankDistributionManager {
   ...
   * @param assetMonthlyEmissionPerSecond The emissions for each months, each asset
   * @param shareRatios The share ratio for each asset
   */
