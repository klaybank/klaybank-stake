...
/**
 * @notice implementation of the KBT token contract
 * @author Aave
 */
abstract contract GovernancePowerDelegationKIP7 is KIP7, IGovernancePowerDelegationToken {
   ...
   * In this initial implementation with no KBT minting, simply returns the current supply
   * A snapshots mapping will need to be added in case a mint function is added to the KBT token in the future
   **/
   ...
   * the KBT token and StakeToken already include a mapping for the snapshots, so we require contracts
